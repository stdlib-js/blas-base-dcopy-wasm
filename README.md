...
```javascript
import dcopy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dcopy-wasm@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dcopy-wasm@deno/mod.js';
```
